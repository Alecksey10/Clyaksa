...
class CommandsVizualizerController(QObject):
    ...
    def set_commands_iterator(self, commands_iterator:CommandsIterator):
        ...
        self.commands_transformator.rotation_center_x = self.commands_transformator.shift_x + self._commands_iterator.width/2
        self.commands_transformator.rotation_center_y = self.commands_transformator.shift_y + self._commands_iterator.height/2
